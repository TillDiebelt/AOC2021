...
namespace Day10
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (test1 == 26397) Console.WriteLine("test 1 successful"); else Console.WriteLine("test 1 failed");
            var test2 = Solver.SolvePart2(inputPathTest);
            Console.WriteLine(test2);
            if (test2 == 288957) Console.WriteLine("test 2 successful"); else Console.WriteLine("test 2 failed");
            Console.ReadLine();
        }
	}
}
